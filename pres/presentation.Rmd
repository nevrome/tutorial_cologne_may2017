...
\textcolor{black}{\textbf{1.}} RStudio: Ein neues R Markdown Dokument anlegen
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.55]{images/history.png}
...
\textcolor{black}{\textbf{2.}} Kriging und Positionsbestimmung im R Markdown Dokument hinzufügen
...
* \danger\  Das ist **kein** produktionsfertiges R-Paket. Wir haben einige essenzielle Aspekte ausgelassen: \keys{\ctrl + \shift + E}
