...
\underline{\textbf{Hadley Wickham -- R packages}}  
...
```{r, eval=FALSE}
install.packages(c("recexcavAAR", "rgl", "tidyverse"))
```
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.52]{images/history.png}
...
\underline{\textbf{Hadley Wickham -- R for Data Science}}  
http://r4ds.had.co.nz/
